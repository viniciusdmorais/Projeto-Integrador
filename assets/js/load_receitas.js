const listReceitas = [
    {
        ...
        ingredientes:
            "Secos:;2 xicaras de farinha de trigo; 1/4 xicaras de amido de milho; 1/2 xicaras de cacau em pó; 1+1/2 xicaras de açucar; 1 cololher de sopa de bicarbonato de sódio; 1/2 cololher de sopa de fermento quimico; pitada sal; Molhados:; 1+1/2 xicaras de agua; 1/2 xicara de oleo; 1/4 xicara de café; 1 colher de sopa de vinagre",
        preparo:
            "Coloque o forno para pré aquecer em 200ºC; Unte uma forma com óleo e polvilhe amido de milho ou farinha; Em uma vasilha misture todos os secos peneirados; Em outro recipiente coloque todos os molhados e os despeje sobre os secos; Misture todos os ingredientes até obter uma massa homogênea; Despeje a massa na forma e a coloque no forno; Após 10 minutos reduzir a temperatura para 180ºC; Após assado retirar do forno; Desenformar com o bolo frio ou morno mais para fio; Dicas:; Dê preferência a óleos neutros, como os de: girassol, canola e milho; Caso não possua amido de milho basta usar a mesma quantidade de farinha de trigo, o amido de milho serve para deixar o bolo mais fofinho ainda; Ao fazer o café faça ele forte, idepende se é coado, expresso… ele serve para destacar o sabor do cacau; O vinagre de preferência para o de álcool ou de maçã, porém outros não costumam deixar sabor residual, ele serve para auxiliar no crescimento da massa",
        mediaNota: 5,
    },
    {
        idReceita: 2,
