const listaRestaurantes = [
  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest1.png" alt="mapa_google" title="Google Maps Restaurante">',
...

  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest2.png" alt="mapa_google" title="Google Maps Restaurante">',
      ...
      
  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest3.png" alt="mapa_google" title="Google Maps Restaurante">',
      ...
      
  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest4.png" alt="mapa_google" title="Google Maps Restaurante">',
      ...
      
  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest5.png" alt="mapa_google" title="Google Maps Restaurante">',
      ...
      
  {
      ...
      googleFoto: '<img class="imagem_restaurante" width="350px" height="350px" src="assets/images/img_reh/foto_mapa_rest6.png" alt="mapa_google" title="Google Maps Restaurante">',
...
function CriaTopRestaurantes() {
  ...
  listaRestaurantes.sort((a, b) => b.mediaNota - a.mediaNota); // ordenando as receitas pelo valor da média

  listaRestaurantes.length = 3; // limitando aos 3 primeiros para ser apresentado no for abaixo
  ...
  for (let i = 0; i <= listaRestaurantes.length; i++) {
    ...
    elemRankRestorant.innerHTML = `
        <figure id="nome_restaurantes">
            <a href="restaurante_indicado.html?idRestaurante=${listaRestaurantes[i].idRestaurante}">
                <img src="${listaRestaurantes[i].imagem}" alt="${listaRestaurantes[i].nomeRestaurante}">
                <figcaption> ${listaRestaurantes[i].nomeRestaurante} </figcaption>
            </a>
         <figure>     
            `;
